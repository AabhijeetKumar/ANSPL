...
//   return (
//     <div className="w-full flex  md:flex-row items-center justify-between px-5 md:px-50 py-40  gap-10 md:gap-0">
...
//         className="text-4xl md:text-5xl font-semibold text text-center text-blue-500 "
//       >
//         Contact Us
//       </motion.h1>
